...
public class test {
     ...
     */
    @Test
    void testEmbeddingImageByStream() throws Exception {
        InputStream is = new FileInputStream("E:\\a\\b.jpg");
        String desc = vlTool.processImageByStream(is, "image/jpeg");
        System.out.println("识图结果: " + desc);
    }

    @Test
    void testEmbeddingBase64() throws IOException {
        InputStream is = new FileInputStream("E:\\a\\b.jpg");
        ByteArrayOutputStream baos = new ByteArrayOutputStream();
        is.transferTo(baos);
        byte[] bytes = baos.toByteArray();
        String base64 = Base64.getEncoder().encodeToString(bytes);
        System.out.println("图片原始大小: " + bytes.length + " bytes, base64长度: " + base64.length());
        String desc = vlTool.processImageByBase64(base64, "image/jpg");
        System.out.println("识图结果: " + desc);
        is.close();
    }
    ...
    void testProcessImageByUrl() {
        String desc = vlTool.processImageByUrl("E:\\a\\b.jpg");
